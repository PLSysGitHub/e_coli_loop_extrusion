...
class simulationBondUpdater(object):
    ...
    def __init__(self,N,smcTrajectoryFile,which_step):
        ...
        :param smcTrajectoryFile: a file with SMC positions
        :param which_step: which step to take from the SMC trajectory file
    ...
    def LEF_simulation(self, bondForce, smcTimeSteps = 2):
        ...
        :param smcTimeSteps: how many time steps to load from the SMC trajectory file
        :return:
        """
